...
# 
# \description{ 
#	This is the class representing the rate matrices. The QMatrix objects store two rate matrices: one containes
...
#	parameters define the rates of the Event objects generated by the assotiated GeneralSubstitution objects.          	
#
#	The QMatrix objects have a bidirectonal relationship with the GeneralSubstitution object as they store a reference 
#	to the assotiated process objects. The QMatrix objects do not have a write protection field, but they use the one
#	from the assotiated GeneralSubstitution object.
#
...
#	\item{rate.list}{A list of unscaled event rates and the assotiated event names. It will be passed to the \code{setRateList.QMatrix} method.}
#	\item{process}{A GeneralSubstitution object to be assotiated with the QMatrix object.}
# 	\item{...}{Not used.}
#	}
# 
...
# 
# @title "Get the process object assotiated with a QMatrix object" 
# 
# \description{ 
#	@get "title".
# } 
...
#	p
#	# get the assotiated QMatrix object from p
#	m<-p$qMatrix
#	summary(m)
#	# get the assotiated process from m
#	m$process
#	# clone p
#	pp<-clone(p)
#	# assotiate m with pp
...
# 
# @title "Get the Alphabet object assotiated with a QMatrix object" 
# 
# \description{ 
#	@get "title".
# } 
