...
#	The rates of the events are calculated as the product of the general rate of the process 
#       and the "rate.multiplier" site-process specific parameter.
#	The simulation code calls the \code{Perform} method on the selected insertion event objects which calls 
#	the insertion event handler performing the insertion.
#
#	The insert lengths are proposed by the function stored in the \code{proposeBy} virtual field. The function must have the following arguments:
#	process (the insertion process object).
#
#	The insertion events are accepted/rejected by the function stored in the \code{acceptBy} virtual field.
...
#	The probability of accepting/rejecting an insertion is calculated as the product of the "insertion.tolerance"
#	site-process specific parameters of the sites neighboring the insertion. The number of sites considered is
#	determined by the \code{acceptWin} virtual field.
#
...
#	The default generator function truncates/duplicates the seqeunce object stored in the \code{templateSeq} virtual field to get a seqeunce
...
#	)
#	i
#	# check if inherits from GeneralInsertor
...
#	generateInsert(i)
#	# create a sequnce object and attach process
...
#	The rates of the dceletion events are calculated as the product of the general rate
#	of the process and the "rate.multiplier" site-process specific parameter.
#
#	The simulation code calls the \code{Perform} method on the selected deletion event objects
#	which calls the handler function performing the deletion.
#
...
#
#	The deletion randomly affects the sites from the left or from the right of the target position (but never both). The position
#	which are out of range are discarded.
#
...
#	parameters from the sites affected by the deletionj event.
#
#	@classhierarchy
# }
#	
...
#       )
#	d
#	# check if inherits from GeneralDeletor
#	is.GeneralDeletor(d)
#	# get object summary
#	summary(d)
#	# set/get name
